...
@endsection
@section('content')
    <div class="authentication-bg min-vh-100" style="background-image: url('https://i.imgur.com/8SAPTPm.jpeg');"> <!-- Placeholder image URL -->
    ...
    @push('redirect')
    <script>
        window.location = "{{ route('index-user') }}"; // Redirect to index-user route
    </script>
@endpush
